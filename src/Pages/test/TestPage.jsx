  ...
  const handleSubmit = () => {
    ...
    testData.questions.forEach((question) => {
      ...
      if (selectedAnswer && selectedAnswer.isCorrect) {
        const newUserPoints =
          parseInt(userPoints) + parseInt(localStorage.getItem("testPointsForCompleting"));
    ...
    <Container className={styles.container}>
      <div>
        {testData ? (
          <div>
              ...
              {testData.questions.map((question, index) => (
                ...
                >
                  ...
                  {results[question.id] !== undefined && (
                    <div
                      className={
                        results[question.id] ? styles.correctMessage : styles.incorrectMessage
                      }
                    >
            ...
            {!showNextButton && (
              <Button
                ...
                disabled={Object.keys(results).length === testData.questions.length}
              >
                Ответить
              </Button>
            )}
          ...
          <Alert variant="info">Загрузка теста...</Alert>
        )}
      </div>
    </Container>
  );
